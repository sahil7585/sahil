...
\033[1;91m
\033[1;97mღ꧁ღ╭⊱ꕥ Sahil jaan ꕥ⊱╮ღ꧂ღ
\033[1;91m
\033[1;91m╔╣♥❀ ZUBI khan  ❀❥╠╗
...
def Zeek():
    os.system('clear')
    print logo1
    print '\x1b[1;91m[1]  START CLONING With sahil'
    time.sleep(0.10)
    print '\x1b[1;92m[2] sahil FB ACCOUNT'
    time.sleep(0.10)
    ...
    time.sleep(0.10)
    print '\x1b[1;91m[6] SAHIL FACEBOOK'
    time.sleep(0.10)
